...
const CMS = (() => {
  ...
  const DEFAULTS = {
    ...
    offres: {
      ...
      items: [
        {
          id: "starter",
          icon: "🚀", tag: "Starter", title: "Ear Me Up",
          ...
          btnText: "En savoir plus", btnLink: "#contact", btnStyle: "outline",
          featured: false, badge: ""
        },
        {
          id: "mesure",
          icon: "✨", tag: "Sur mesure", title: "Ta com sur mesure",
          ...
          btnText: "Prendre RDV", btnLink: "#contact", btnStyle: "primary",
          featured: true, badge: "✨ Recommandé"
        },
        {
          id: "contenu",
          icon: "🎨", tag: "Contenu", title: "Visuels & Articles",
    ...
    articles: {
      ...
      items: [
        {
          id:"a1", category:"Interview", categoryLabel:"Interview", date:"Mai 2025", dateLabel:"Mai 2025",
          author:"Audrey Duval-Lebret", readTime:"6 min", image:"",
          ...
          content:`<div class="highlight-box"><p>"J'invente le futur." — Xavier CARRIOU</p></div><h2>L'homme derrière la vision</h2><p>Très tôt dans sa carrière, Xavier CARRIOU a été frappé par le désarroi de patients souffrant d'acouphènes pour lesquels la médecine classique apportait peu ou pas de solutions.</p><div class="article-cta"><h3>Tu veux en savoir plus ?</h3><p>Découvre toutes les ressources sur l'audiologie</p><a href="ressources.html" class="btn-cta">Voir les ressources →</a></div>`
        },
        {
          id:"a2", category:"Interview", categoryLabel:"Interview", date:"Fév. 2025", dateLabel:"Fév. 2025",
          author:"Audrey Duval-Lebret", readTime:"7 min", image:"assets/azdine-ezzahti.jpg",
          ...
          content:`<div class="highlight-box"><p>"Je ne suis pas tombé dans l'audiologie par hasard, mais presque." — Azdine Ezzahti</p></div><h2>Un métier où rigueur et passion se rencontrent</h2><p>Après plus de dix ans dans le domaine, ce qui l'anime toujours : apprendre et se sentir utile.</p><div class="article-cta"><h3>Envie d'échanger ?</h3><p>Contacte Audrey pour en discuter</p><a href="index.html#contact" class="btn-cta">Me contacter →</a></div>`
        },
        {
          id:"a3", category:"Portrait", categoryLabel:"Portrait", date:"Jan. 2025", dateLabel:"Jan. 2025",
          author:"Audrey Duval-Lebret", readTime:"6 min", image:"",
          title:"Portrait : Pr Vincent DARROUZET – Un homme de vision",
          excerpt:"\"Je n'avais qu'à m'inscrire dans leurs traces.\" Portrait d'une figure majeure de l'ORL française.",
          tags:["ORL","portrait","CHU Bordeaux","recherche"],
          content:`<div class="highlight-box"><p>"Je n'avais qu'à m'inscrire dans leurs traces. Jean-Pierre Bébéar fut mon guide !" — Pr Vincent Darrouzet</p></div><h2>L'homme derrière le médecin</h2><p>Le Professeur Darrouzet est né dans une famille médicale.</p><div class="article-cta"><h3>Découvre toutes nos interviews</h3><p>Des rencontres inspirantes avec les acteurs de l'audiologie</p><a href="portfolio.html" class="btn-cta">Voir tous les articles →</a></div>`
        }
      ]
    },
    contact: {
  ...
  /* ── CLÉ UNIQUE partagée avec site.js ── */
  ...
  function save(data) {
    // Normalise les articles avant la sauvegarde :
    // s'assure que articles est toujours {sectionLabel, title, items:[]}
    if (data.articles) {
      if (Array.isArray(data.articles)) {
        data.articles = {
          sectionLabel: DEFAULTS.articles.sectionLabel,
          title:        DEFAULTS.articles.title,
          items:        data.articles
        };
      }
      // S'assure que chaque article a categoryLabel et dateLabel
